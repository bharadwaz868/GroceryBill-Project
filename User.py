...
#                     item_prices.append(float(quant * Product.Price[item_index]))
#                     print(f"{float(quant * Product.Price[item_index])} INR")
#                     Product.Stock[item_index] = Product.Stock[item_index] - quant
#                     print(f"{Product.Stock[item_index]} LEFT")
#                 else:
#                     print("No Stock")
#                     print(f"{Product.Stock[item_index]} LEFT")
#             else:
...
#         print("Item_Stock : ", Product.Stock3)
#         item = int(input("Enter the item number : "))
#         quant = float(input("Enter the quantity : "))
#
#
